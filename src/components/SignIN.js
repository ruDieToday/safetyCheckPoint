              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  border-gray-300 rounded-md"
                      ...
                      <div class="relative">
                        <a
                          class="w-full inline-block pt-4 pr-5 pb-4 pl-5 text-xl font-medium text-center text-white bg-purple-600
                  rounded-lg transition duration-200 hover:bg-purple-700 ease"
                        >
                          Submit
                        </a>
                      </div>
